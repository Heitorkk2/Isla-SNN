...
class SpikingMLP(nn.Module):
    ...
    def __init__(self, config: ModelConfig):
        ...
        # Learnable membrane mixing coefficient (improvement 3)
    ...
    def forward(self, x):
        ...
        # Mix spike (binary) + alpha * membrane (continuous) — improvement 3
...
class SpikingBlock(nn.Module):
    ...
    def __init__(self, config: ModelConfig):
        ...
        # The model learns how much to amplify with direct path
    ...
    def forward(self, h, mask=None, cache=None):
        ...
        h = h + attn_out  # residual na atenção: mantido
        h_pre = h  # guarda para o boost residual
